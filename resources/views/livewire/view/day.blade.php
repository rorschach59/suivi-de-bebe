...
<div>
    ...
    <div class="grid grid-cols-3 items-center my-12">
        ...
        <div class="justify-self-end self-end pr-2">
            ...
            <button data-modal-target="updateReminderModal" data-modal-toggle="updateReminderModal" class="hidden"
                    type="button">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        >{!! $reminder !!}</textarea>
                            ...
                            <div class="flex justify-around p-2 space-x-2">
                                ...
                                <button id="closeModal" type="button" class="secondary-button">
                                    Annuler
                                </button>
                            </div>
                        </form>
    ...
    <div id="reminderTextarea" class="p-2 mt-2 bg-myGreen-400 rounded-lg mb-14 {{ empty($reminder) ? 'h-10' : '' }}">
        @if( !empty($reminder) )
            {!! nl2br($reminder) !!}
        @endif
    </div>
